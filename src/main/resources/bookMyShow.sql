...
create table show (id  bigserial not null, created_at timestamp, updated_at timestamp, is_available_for_booking boolean, show_time timestamp, city_id int8, movie_id int8, screen_id int8, primary key (id))
